# OpenDFM
<pre>
OpenDFM is a utility for pulling remote logs for date formated datalogs from IDEC PLCs. I cant do anything about the transferspeed, but we can improve reliability.
<b>Motive:</b>
